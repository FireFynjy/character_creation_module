...
def start_training(character):
    ...
    game_classes = {Warrior: f'{character.name}, ты Воитель — великий мастер ближнего боя.',
                    Mage: f'{character.name}, ты Маг — превосходный укротитель стихий.',
                    Healer: f'{character.name}, ты Лекарь — чародей, способный исцелять раны.'}
    
    print(game_classes[character])
